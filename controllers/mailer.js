                                    ...
                                    >
                                      ...
                                      >
                                        <img
                                          ...
                                          width="75.8"
                                        />
                                        <h1 style="padding-left: 16px">ProHelp</h1>
                                      </div>
                                    </td>
                                  </tr>
                                </table>
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 140%">
                                    <strong
                                      >T H A N K S&nbsp; &nbsp;F O R&nbsp; &nbsp;C O
                                      N T A C T I N G&nbsp; &nbsp;U S !</strong
                                    >
                                  </p>
                                </div>
                              </td>
                            ...
                            <tr>
                              ...
                              <br/>
                                  ...
                                  <p style="font-size: 14px; line-height: 160%">
                                    <span
                                      style="font-size: 18px; line-height: 28.8px"
                                      >Your request is well received. Your ticket
                                      number is <strong>${ticketNo}</strong>
                                    </span>
                                  </p>
                                  <p style="font-size: 14px; line-height: 160%">
                                    <span
                                      style="font-size: 18px; line-height: 28.8px"
                                      >An agent will be assigned to attend to your
                                      request. Meanwhile, feel free to visit our
                                      site to checkout other products and services
                                      we offer.</span
                                    >
                                  </p>
                                </div>
                          ...
                          <tbody>
                            <tr>
                              ...
                              >
                                ...
                                [endif]-->
                                <div align="center">
                                  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:46px; v-text-anchor:middle; width:148px;" arcsize="8.5%"  stroke="f" fillcolor="#ff6600"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Cabin',sans-serif;"><![endif]-->
                                  <a
                                    target="_blank"
                                    class="v-button"
                                    style="
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 140%">
                                    <strong
                                      >${"JOB\t SUCCESSFULLY\t POSTED"}</strong
                                    >
                                  </p>
                                </div>
                              </td>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <p style="font-size: 14px; line-height: 160%">
                                    <span
                                      style="font-size: 18px; line-height: 28.8px"
                                      >${"Thank you for posting your job on our platform \nYou're almost about to get a professional for your job execution. Feel free to explore other services we offer on our platform!"}  </span
                                    >
                                  </p>
                                </div>
                              </td>
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 140%">
                                    <strong
                                      >${"JOB\t APPILCATION\t SUCCESSFUL"}</strong
                                    >
                                  </p>
                                </div>
                              </td>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <p style="font-size: 14px; line-height: 160%">
                                    <span
                                      style="font-size: 18px; line-height: 28.8px"
                                      >${`Your job application for ${jobTitle} was successfully received. We will keep you notified of new updates. In the meantime, feel free to explore other services we offer on our platform.`}  </span
                                    >
                                  </p>
                                </div>
                              </td>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <p style="font-size: 14px; line-height: 160%">
                                    <span
                                      style="font-size: 18px; line-height: 28.8px"
                                      >${`${applicantName} just submitted an application for your job ${jobTitle}. Go to your account dashboard for more information. In the meantime, feel free to explore other services we offer on our platform.`}  </span
                                    >
                                  </p>
                                </div>
                              </td>
                            ...
                            <tr>
                              ...
                              >
                                <div
                                  ...
                                  "
                                >
                                  <p style="font-size: 14px; line-height: 140%; text-transform: uppercase;">
                                    <strong
                                      >JOB\t  APPILCATION\t ${status}</strong
                                    >
                                  </p>
                                </div>
                              </td>
                              ...
                              >
                                ...
                                >
                                  <p style="font-size: 14px; line-height: 160%">
                                    <span
                                      style="font-size: 22px; line-height: 35.2px"
                                      >${"Hi " + guest?.bio?.firstname + ","}
                                    </span>
                                  </p>
                                  <p style="font-size: 14px; line-height: 160%">
                                    <span
                                      style="font-size: 18px; line-height: 28.8px"
                                      >${`${user?.bio?.firstname} ${user?.bio?.lastname} wants to connect to you. Login to your account to accept or decline connection request. In the meantime, feel free to explore other services we offer on our platform.`}  </span
                                    >
                                  </p>
                                </div>
                              </td>
